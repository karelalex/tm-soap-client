 ...
 * 2019-05-23T12:55:15.905+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TaskEndpointService",
                  wsdlLocation = "http://localhost:9090/taskman/soap/task?wsdl",
                  targetNamespace = "http://soap.tmwebspring.karelin.ru/")
public class TaskEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://soap.tmwebspring.karelin.ru/", "TaskEndpointService");
    public final static QName TaskEndpointPort = new QName("http://soap.tmwebspring.karelin.ru/", "TaskEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/taskman/soap/task?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TaskEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:9090/taskman/soap/task?wsdl");
        }
        WSDL_LOCATION = url;
    }
